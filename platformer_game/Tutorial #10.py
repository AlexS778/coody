...
# Загрузка звуков для выстрела и попадания
bulletSound = pygame.mixer.Sound('bullet.mp3')
hitSound = pygame.mixer.Sound('hit.mp3')

# Загрузка фоновой музыки и воспроизведение
...
class enemy(object):
    ...
    def move(self):
        # Движение врага по заданному пути
        if self.vel > 0:
...
while run:
    ...
    # Обработка попадания снаряда по врагу
    if shootLoop > 0:
        shootLoop += 1
    if shootLoop > 3:
        shootLoop = 0
    ...
    # Выстрел при нажатии клавиши "Пробел"
